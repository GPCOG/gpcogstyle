...
#'
#' \code{set_gpcog_defaults} provides a [ggplot2] theme formatted according to the
#' GPCOG style guide, with sensible defaults.
#'
...
#' relative to this value.
#' @param scale For `theme_gpcog_map()`. Should the legend theme be continuous or discrete?
#'
#' @import extrafont
#' @import ggrepel
#'
#' @export
#'
set_gpcog_defaults <- function(style = "print",
                              base_size = 9,
                              base_family = "Arial",
                              base_line_size = 0.5,
                              base_rect_size = 0.5,
  ...
  # set default theme to theme_gpcog_*() --------------------------------------

  if (style == "print") {

    ggplot2::theme_set(theme_gpcog_print(base_size = base_size,
    ...
    ggplot2::theme_set(theme_gpcog_map(base_size = base_size,
                                      base_family = base_family,
                                      base_line_size = base_line_size,
                                      base_rect_size = base_rect_size,
                                      scale = scale))
