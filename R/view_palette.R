...
#'
#' \code{view_palette} displays the colors and hexadecimal codes for \code{palette_gpcog_*} vectors.
#'
#' @param palette A \code{palette_gpcog_*} vector from \code{library(gpcogstyle)}.
