#' gpcog_note
#'
#' Add a notes section to the bottom of a plot created with \code{gpcog_plot()}.
#'
...
#' @export
#'
gpcog_note <- function(text, size = 8, width = 132, plural = FALSE) {
  ...
  grob1 <- grid::textGrob(
    ...
    hjust = 0,
    vjust = 1,
    gp = gpar(fontsize = size, fontfamily = "Arial", fontface = "bold", lineheight = 1)
  )
